...
Rectangle {
    ...
    Image {
        ...
        source: {
            if (height < 24)
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-18dp.png";
            else if (height >= 24 && height < 36)
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-24dp.png";
            else if (height >= 36 && height < 48)
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-36dp.png";
            else if (height >= 48 && height < 72)
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-48dp.png";
            else if (height >= 72 && height < 96)
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-72dp.png";
            else
                return "qrc:/images/Camera/ic_"+iconWidget.iconName+"-96dp.png";
        }
    }
