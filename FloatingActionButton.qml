    ...
    Rectangle {
        ...
        Image {
            ...
            function getIconResolution (name) {
                if (height < 24)
                    return "qrc:/images/Camera/ic_"+name+"-18dp.png";
                else if (height >= 24 && height < 36)
                    return "qrc:/images/Camera/ic_"+name+"-24dp.png";
                else if (height >= 36 && height < 48)
                    return "qrc:/images/Camera/ic_"+name+"-36dp.png";
                else if (height >= 48 && height < 72)
                    return "qrc:/images/Camera/ic_"+name+"-48dp.png";
                else if (height >= 72 && height < 96)
                    return "qrc:/images/Camera/ic_"+name+"-72dp.png";
                else
                    return "qrc:/images/Camera/ic_"+name+"-96dp.png";
            }
        }
